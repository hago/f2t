...
class String2DateTransformer : ColumnComparator.Transformer {
    override fun transform(
        ...
        if (src !is String?) {
            throw Exception("Not String input to transform to date")
        }
        return if (src == null) null
        else DateTimeTypeUtils.stringToDateOrNull(src, extra.toSet())
    }
